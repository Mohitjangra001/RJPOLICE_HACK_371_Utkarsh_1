...
const Manage = () => {
    ...
    const updept = async (id, value) => {
        ...
        try {
            const { data } = await axios.put("http://localhost:3000/api/v2/uphod", {
                id: id,
                value: value
            });
    ...
    const addhod = async (e) => {
        e.preventDefault()
        try {
            const { data } = await axios.post("http://localhost:3000//api/v2/addhod", {
                name: hname,
                email: email,
                password: password,
                phone: phone,
    ...
    const adddept = async (e) => {
        e.preventDefault()
        try {
            const { data } = await axios.post("http://localhost:3000/api/v2/department", {
                name: name,
    ...
    const delhod = async (id) => {
        ...
        if (pass === "del") {
            ...
            const { data } = await axios.delete(`http://localhost:3000/api/v2/hod/${id}`)
    ...
    const gethods = async () => {
        try {
            const { data } = await axios.get("http://localhost:3000/api/v3/hods");
            sethods(data.hods)
    ...
    const alldepartments = async () => {
        try {
            setloader(true)
            const response = await axios.get("http://localhost:3000/api/v1/department");
    ...
    const deldep = async (id) => {
        ...
        if (pass === "del") {
            ...
            const { data } = await axios.delete(`http://localhost:3000/api/v2/dep/${id}`)
