...
const Cofeedback = () => {
    ...
    const quesions = async () => {
        try {
            setloader(true);
            const { data } = await axios.get("http://localhost:3000/api/v3/ques");
            console.log(data);
    ...
    const subjects = async () => {
        try {
            ...
            const { data } = await axios.post("http://localhost:3000/api/v3/subjects", {
                sem: sems
            });
    ...
    const handleSubmit = async (e) => {
        ...
        if (feedbackData == "") {
            ...
            try {
                const { data } = await axios.post('http://localhost:3000/api/v3/feedback', {
                    department: dep,
                    sem: sems,
                    course: subject,
                    student: id,
